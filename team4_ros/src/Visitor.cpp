...
int main (int argc, char **argv) 
{
    ...
    ros::init(argc, argv, "VisitorNode"); 
    ...
    //ros::Publisher mypub_object = velPub_handle.advertise<geometry_msgs::Twist>("robot_0/cmd_vel",1000);
        mypub_object = velPub_handle.advertise<geometry_msgs::Twist>("robot_12/cmd_vel",1000);
    ...
    mysub_object = sub_handle.subscribe<nav_msgs::Odometry>("robot_12/base_pose_ground_truth",1000, groundTruthCallback);
